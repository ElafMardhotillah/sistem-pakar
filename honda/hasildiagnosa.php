...
<body>
    ...
    <div class="col-12 text-left"> 
      <h1 class="text text-center text-danger">DETAIL HASIL DETEKSI</h1>
      <div class="form-group"  method="POST">
        ...
        <div class="form-group"  method="POST">
      			<br><label class="control-label col-sm-2">KERUSAKAN :</label>
      		<div class="col-sm-10">
                <?php
                       $tampil = "SELECT * FROM kerusakan where idkerusakan='".$_GET['id']."'";
                       $sql = mysqli_query ($konek_db,$tampil);
        ...
        <div class="form-group"  method="POST">
      		...
      		<div class="col-sm-10">
                <?php
                       ...
                       while($data = mysqli_fetch_array ($sql))
                    {
                       echo "<textarea  rows='4' class='form-control' id='pengendalian'  readonly>".$data['pengendalian']."</textarea><br>";
                    }
                ?>
     		 </div>  
        </div>
